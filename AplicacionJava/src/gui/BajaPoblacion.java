...
/**
 *
 * Formulario para dar de baja una poblacion
 * 
 ...
 * 
 */
public class BajaPoblacion extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BajaPoblacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BajaPoblacion().setVisible(true);
            }
        });
    }
